...
/**
 * This class holds any static strings related to the application.
 * 
 * @author Kal
 *
 */
public final class CHAppSettings {
	...
	public static final String[] CH_ALGORITHMS_LIST = { CH_JARVIS_MARCH_NAME,
			CH_MONOTONE_CHAIN_NAME, CH_SWEEPHULL_NAME };

	public static final String ABOUT_APP_MESSAGE = "Convex Hull App | v 1.0\nKalon Cheong (c) 2014\n\nServing all your Convex Hull Algorithm simulation needs :)";
}
